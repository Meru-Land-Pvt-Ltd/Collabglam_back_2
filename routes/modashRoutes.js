...
// router.get("/locations", ModashController.getModashLocationController);
router.post("/countries/sync", ModashController.syncModashCountries);
router.get("/countries", ModashController.getModashCountries);
router.get("/countries/:countryCode", ModashController.getModashCountryByCode); 
